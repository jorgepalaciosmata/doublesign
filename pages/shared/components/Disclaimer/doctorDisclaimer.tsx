    ...
    return (
        <ScrollView>
            <View style={styles.container}>
                ...
                <Text style={styles.header}>Médico - Identificación del responsable </Text>
...
export default DoctorDisclaimer;